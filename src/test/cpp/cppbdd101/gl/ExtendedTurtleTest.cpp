#include <cppbdd101/gl/ExtendedTurtleTest.hpp>

MockTurtleDelegate * ExtendedTurtleTest::objectUnderTest = nullptr;
log4cxx::LoggerPtr ExtendedTurtleTest::logger = log4cxx::Logger::getLogger(std::string("cppbdd101.gl.ExtendedTurtleTest"));
