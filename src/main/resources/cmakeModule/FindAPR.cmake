...
macro(_apr_invoke _varname _regexp)
    execute_process(
        ...
        ERROR_VARIABLE  _apr_error)

    message(STATUS "OUTPUT_VARIABLE ${OUTPUT_VARIABLE} <-> RESULT_VARIABLE ${RESULT_VARIABLE} <-> ERROR_VARIABLE ${ERROR_VARIABLE}")

    if(_apr_failed)
    # if(NOT _apr_failed STREQUAL "0")
