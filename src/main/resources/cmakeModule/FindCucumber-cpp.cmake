...
#        )
        ...
        mark_as_advanced(CUCUMBER_LIBRARY CUCUMBER_NO_MAIN_LIBRARY) 
        ...
        if (CUCUMBER_LIBRARY AND CUCUMBER_INCLUDE_DIR)
		    ...
		    INTERFACE_LINK_LIBRARIES  "GTest::GTest;GMock::GMock;Boost::date_time;Boost::filesystem;Boost::regex;Boost::system;Boost::thread"
