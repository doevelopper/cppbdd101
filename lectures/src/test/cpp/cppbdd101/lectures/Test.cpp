...
#include <cppbdd101/lectures/Test.hpp>

log4cxx::LoggerPtr cppbdd101::lectures::Test::logger = log4cxx::Logger::getLogger(std::string("cppbdd101.Test") );

const unsigned long cppbdd101::lectures::Test::LOGGER_WATCH_DELAY = 5000UL;


cppbdd101::lectures::Test::Test()
...
cppbdd101::lectures::Test::Test(std::string & suite, unsigned int iteration)
    : m_testSuites(suite)
...
int cppbdd101::lectures::Test::run (int argc, char * argv[])
{
    LOG4CXX_TRACE(logger, __LOG4CXX_FUNC__);
...
void cppbdd101::lectures::Test::showUsage(std::string name)
{
