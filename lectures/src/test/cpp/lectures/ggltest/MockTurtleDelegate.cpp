...
// log4cxx::LoggerPtr logger = log4cxx::Logger::getLogger(std::string("diactics.core.exple.DelegateMockTurtle"));
MockTurtleDelegate::MockTurtleDelegate()
: logger (log4cxx::Logger::getLogger(std::string("cppbdd101.gl.DelegateMockTurtle")))
{
